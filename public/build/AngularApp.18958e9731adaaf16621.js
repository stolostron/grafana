(self.webpackChunkgrafana=self.webpackChunkgrafana||[]).push([[4704],{32530:l=>{var a=`<div ng-transclude class="gf-form-query-content"></div>

`,t=a,e="public/app/angular/panel/partials/query_editor_row.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},49851:l=>{var a=`<datasource-http-settings-next on-change="onChange" datasourceconfig="current" showaccessoptions="showAccessOption" defaulturl="suggestUrl" showforwardoauthidentityoption="showForwardOAuthIdentityOption">
`,t=a,e="public/app/angular/partials/http_settings_next.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},98296:l=>{var a=`<div class="gf-form-group">
  <div class="gf-form">
...
`,t=a,e="public/app/angular/partials/tls_auth_settings.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},3174:l=>{var a=`<page-header model="ctrl.navModel"></page-header>
...
<footer>
`,t=a,e="public/app/features/admin/partials/admin_home.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},71749:l=>{var a=`<page-header model="navModel"></page-header>
...
<footer>
`,t=a,e="public/app/features/admin/partials/edit_org.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},57223:l=>{var a=`<page-header model="ctrl.navModel"></page-header>
...
`,t=a,e="public/app/features/admin/partials/stats.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},50349:l=>{var a=`<page-header model="ctrl.navModel"></page-header>
...
`,t=a,e="public/app/features/admin/partials/styleguide.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},47218:l=>{var a=`<div ng-if="ctrl.panel.alert">
...
`,t=a,e="public/app/features/alerting/partials/alert_tab.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},96155:l=>{var a=`
...
`,t=a,e="public/app/features/annotations/partials/event_editor.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},3311:l=>{var a=`<div class="modal-body" ng-cloak>
...
`,t=a,e="public/app/partials/confirm_modal.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},81464:l=>{var a=`<div class="modal-header">
...
</div>`,t=a,e="public/app/partials/modal.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},60596:l=>{var a=`<page-header model="navModel"></page-header>
...
<footer>
`,t=a,e="public/app/partials/reset_password.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},53221:l=>{var a=`<page-header model="navModel"></page-header>
...
<footer>
`,t=a,e="public/app/partials/signup_invited.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},54385:l=>{var a=`<div class="editor-row">
...
`,t=a,e="public/app/plugins/panel/graph/axes_editor.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},65618:l=>{var a=`<div class="gf-form-group">
...
`,t=a,e="public/app/plugins/panel/graph/tab_display.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},79543:l=>{var a=`<div class="editor-row">
...
`,t=a,e="public/app/plugins/panel/graph/tab_legend.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},88444:l=>{var a=`<div class="graph-series-override" ng-repeat="override in ctrl.panel.seriesOverrides" ng-controller="SeriesOverridesCtrl">
  <div class="gf-form">
...
`,t=a,e="public/app/plugins/panel/graph/tab_series_overrides.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},32614:l=>{var a=`<graph-threshold-form panel-ctrl="ctrl"></graph-threshold-form>
`,t=a,e="public/app/plugins/panel/graph/tab_thresholds.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},93567:l=>{var a=`<graph-time-region-form panel-ctrl="ctrl"></graph-time-region-form>
`,t=a,e="public/app/plugins/panel/graph/tab_time_regions.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},25511:l=>{var a=`<div class="gf-form-group">
...
`,t=a,e="public/app/plugins/panel/graph/thresholds_form.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},37664:l=>{var a=`<div class="gf-form-group">
...
`,t=a,e="public/app/plugins/panel/graph/time_regions_form.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},30677:l=>{var a=`<div class="editor-row">
  <div class="section gf-form-group">
...
`,t=a,e="public/app/plugins/panel/heatmap/partials/axes_editor.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},95922:l=>{var a=`<div class="editor-row">
  <div class="section gf-form-group">
...
`,t=a,e="public/app/plugins/panel/heatmap/partials/display_editor.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},93818:l=>{var a=`<div class="edit-tab-content" ng-repeat="style in editor.panel.styles">
  <div class="gf-form-group">
    <h5 class="section-heading">Options</h5>
    <div class="gf-form-inline">
      <div class="gf-form gf-form--grow">
...
`,t=a,e="public/app/plugins/panel/table-old/column_options.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},72615:l=>{var a=`<div class="gf-form-group">
  <div class="grafana-info-box">
...
`,t=a,e="public/app/plugins/panel/table-old/editor.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},91860:l=>{var a=`<div class="table-panel-container">
...
`,t=a,e="public/app/plugins/panel/table-old/module.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},11461:(l,a,t)=>{var e={"./angular/panel/partials/query_editor_row.html":32530,"./angular/partials/http_settings_next.html":49851,"./angular/partials/tls_auth_settings.html":98296,"./features/admin/partials/admin_home.html":3174,"./features/admin/partials/edit_org.html":71749,"./features/admin/partials/stats.html":57223,"./features/admin/partials/styleguide.html":50349,"./features/alerting/partials/alert_tab.html":47218,"./features/annotations/partials/event_editor.html":96155,"./partials/confirm_modal.html":3311,"./partials/modal.html":81464,"./partials/reset_password.html":60596,"./partials/signup_invited.html":53221,"./plugins/panel/graph/axes_editor.html":54385,"./plugins/panel/graph/tab_display.html":65618,"./plugins/panel/graph/tab_legend.html":79543,"./plugins/panel/graph/tab_series_overrides.html":88444,"./plugins/panel/graph/tab_thresholds.html":32614,"./plugins/panel/graph/tab_time_regions.html":93567,"./plugins/panel/graph/thresholds_form.html":25511,"./plugins/panel/graph/time_regions_form.html":37664,"./plugins/panel/heatmap/partials/axes_editor.html":30677,"./plugins/panel/heatmap/partials/display_editor.html":95922,"./plugins/panel/table-old/column_options.html":93818,"./plugins/panel/table-old/editor.html":72615,"./plugins/panel/table-old/module.html":91860,"app/angular/panel/partials/query_editor_row.html":32530,"app/angular/partials/http_settings_next.html":49851,"app/angular/partials/tls_auth_settings.html":98296,"app/features/admin/partials/admin_home.html":3174,"app/features/admin/partials/edit_org.html":71749,"app/features/admin/partials/stats.html":57223,"app/features/admin/partials/styleguide.html":50349,"app/features/alerting/partials/alert_tab.html":47218,"app/features/annotations/partials/event_editor.html":96155,"app/partials/confirm_modal.html":3311,"app/partials/modal.html":81464,"app/partials/reset_password.html":60596,"app/partials/signup_invited.html":53221,"app/plugins/panel/graph/axes_editor.html":54385,"app/plugins/panel/graph/tab_display.html":65618,"app/plugins/panel/graph/tab_legend.html":79543,"app/plugins/panel/graph/tab_series_overrides.html":88444,"app/plugins/panel/graph/tab_thresholds.html":32614,"app/plugins/panel/graph/tab_time_regions.html":93567,"app/plugins/panel/graph/thresholds_form.html":25511,"app/plugins/panel/graph/time_regions_form.html":37664,"app/plugins/panel/heatmap/partials/axes_editor.html":30677,"app/plugins/panel/heatmap/partials/display_editor.html":95922,"app/plugins/panel/table-old/column_options.html":93818,"app/plugins/panel/table-old/editor.html":72615,"app/plugins/panel/table-old/module.html":91860};function n(s){var r=o(s);return t(r)}function o(s){if(!t.o(e,s)){var r=new Error("Cannot find module '"+s+"'");throw r.code="MODULE_NOT_FOUND",r}return e[s]}n.keys=function(){return Object.keys(e)},n.resolve=o,l.exports=n,n.id=11461}}]);

//# sourceMappingURL=AngularApp.18958e9731adaaf16621.js.map