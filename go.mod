...
require (
	...
	github.com/aws/aws-sdk-go-v2/credentials v1.19.22 // @grafana/grafana-operator-experience-squad
	...
	github.com/aws/aws-sdk-go-v2/service/sts v1.43.2 // @grafana/grafana-operator-experience-squad
	github.com/aws/smithy-go v1.27.2 // @grafana/aws-datasources
	...
	github.com/grafana/loki/v3 v3.6.12 // @grafana/observability-logs
	...
	github.com/prometheus/prometheus v0.312.1-0.20260612131846-2ad3a8717015 // @grafana/alerting-backend
	...
	go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploggrpc v0.19.0 // indirect; @grafana/grafana-operator-experience-squad
	...
	go.opentelemetry.io/otel/log v0.20.0 // indirect; @grafana/grafana-operator-experience-squad
	go.opentelemetry.io/otel/sdk v1.44.0 // @grafana/grafana-backend-group
	go.opentelemetry.io/otel/sdk/log v0.20.0 // indirect; @grafana/grafana-operator-experience-squad
...
replace (
	...
	// Pin gomemcache to loki v3.6.0-compatible version
	github.com/grafana/gomemcache => github.com/grafana/gomemcache v0.0.0-20250828162811-a96f6acee2fe
	...
	// Pin OpenTelemetry log packages for compatibility with dagger
	...
	go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploghttp => go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploghttp v0.20.0
	go.opentelemetry.io/otel/exporters/stdout/stdoutlog => go.opentelemetry.io/otel/exporters/stdout/stdoutlog v0.20.0
...
exclude (
	...
	// gomemcache 20250828162811 is now compatible since loki was updated to v3.6.0
