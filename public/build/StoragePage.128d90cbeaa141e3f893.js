"use strict";(self.webpackChunkgrafana=self.webpackChunkgrafana||[]).push([[7675],{15112:(Y,U,n)=>{n.r(U),n.d(U,{default:()=>be});var i=n(5819),e=n(76687),N=n(28476),j=n(47965),J=n(87382),T=n(52901),z=n(77695),M=n(23061),R=n(68127),Z=n(94197),s=n(29480),u=n(31098),S=n(90781),O=n(92329),w=n(78426),b=n(32634),X=n(39874);function k({onPathChange:t}){return e.createElement("div",null,e.createElement("div",null,"TODO... Add ROOT"),e.createElement(s.zx,{variant:"secondary",onClick:()=>t("/")},"Cancel"))}var H=n(86832),V=n(23707);function q({pathName:t,onPathChange:r,rootIcon:m}){const a=(0,T.wW)(_),l=t.split("/").filter(Boolean);return e.createElement("ul",{className:a.breadCrumb},m&&e.createElement("li",null,e.createElement(V.J,{name:m,onClick:()=>r("")})),l.map((o,$)=>{let g="/"+l.slice(0,$+1).join("/");const p=()=>r(g),x=$===l.length-1;return e.createElement("li",{key:(0,H.uniqueId)(o),onClick:x?void 0:p},o)}))}function _(t){return{breadCrumb:i.css`
      list-style: none;
  ...
  `,icon:i.css`
    ...
    // max-height: 147px;
    // fill: ${t.colors.text.primary};
  `});var ue=n(37316);function me({listing:t,view:r}){const m=(0,T.wW)(ge);switch(r){case C.Config:return e.createElement("div",null,"CONFIGURE?");case C.Perms:return e.createElement("div",null,"Permissions")}return e.createElement("div",{className:m.tableWrapper},e.createElement(G.Z,null,({width:a,height:l})=>e.createElement("div",{style:{width:`${a}px`,height:`${l}px`}},e.createElement(ue.i,{height:l,width:a,data:t,noHeader:!1,showTypeIcons:!1,resizable:!1}))))}const ge=t=>({wrapper:i.css`
    display: flex;
    flex-direction: column;
    height: 100%;
  `,tableControlRowWrapper:i.css`
