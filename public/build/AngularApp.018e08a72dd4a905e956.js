(self.webpackChunkgrafana=self.webpackChunkgrafana||[]).push([[8888],{31625:t=>{var s=`<div ng-transclude class="gf-form-query-content"></div>

`,a=s,e="public/app/angular/panel/partials/query_editor_row.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},71047:t=>{var s=`<datasource-http-settings-next on-change="onChange" datasourceconfig="current" showaccessoptions="showAccessOption" defaulturl="suggestUrl" showforwardoauthidentityoption="showForwardOAuthIdentityOption" securesocksdsproxyenabled="secureSocksDSProxyEnabled">
`,a=s,e="public/app/angular/partials/http_settings_next.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},70928:t=>{var s=`<div class="gf-form-group">
  <div class="gf-form">
...
`,a=s,e="public/app/angular/partials/tls_auth_settings.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},64833:t=>{var s=`<page-header model="ctrl.navModel"></page-header>
...
<footer>
`,a=s,e="public/app/features/admin/partials/admin_home.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},49135:t=>{var s=`<page-header model="navModel"></page-header>
...
<footer>
`,a=s,e="public/app/features/admin/partials/edit_org.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},98508:t=>{var s=`<page-header model="ctrl.navModel"></page-header>
...
`,a=s,e="public/app/features/admin/partials/stats.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},16422:t=>{var s=`<page-header model="ctrl.navModel"></page-header>
...
`,a=s,e="public/app/features/admin/partials/styleguide.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},18339:t=>{var s=`
...
`,a=s,e="public/app/features/annotations/partials/event_editor.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},46698:t=>{var s=`<div class="modal-body" ng-cloak>
...
`,a=s,e="public/app/partials/confirm_modal.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},85913:t=>{var s=`<div class="modal-header">
...
</div>`,a=s,e="public/app/partials/modal.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},2591:t=>{var s=`<page-header model="navModel"></page-header>
...
<footer>
`,a=s,e="public/app/partials/reset_password.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},50182:t=>{var s=`<page-header model="navModel"></page-header>
...
<footer>
`,a=s,e="public/app/partials/signup_invited.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},65219:t=>{var s=`<div class="editor-row">
...
`,a=s,e="public/app/plugins/panel/graph/axes_editor.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},41026:t=>{var s=`<div class="gf-form-group">
...
`,a=s,e="public/app/plugins/panel/graph/tab_display.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},29375:t=>{var s=`<div class="editor-row">
...
`,a=s,e="public/app/plugins/panel/graph/tab_legend.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},23957:t=>{var s=`<div class="graph-series-override" ng-repeat="override in ctrl.panel.seriesOverrides" ng-controller="SeriesOverridesCtrl">
  <div class="gf-form">
...
`,a=s,e="public/app/plugins/panel/graph/tab_series_overrides.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},86486:t=>{var s=`<graph-threshold-form panel-ctrl="ctrl"></graph-threshold-form>
`,a=s,e="public/app/plugins/panel/graph/tab_thresholds.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},17165:t=>{var s=`<graph-time-region-form panel-ctrl="ctrl"></graph-time-region-form>
`,a=s,e="public/app/plugins/panel/graph/tab_time_regions.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},37647:t=>{var s=`<div class="gf-form-group">
...
`,a=s,e="public/app/plugins/panel/graph/thresholds_form.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},3390:t=>{var s=`<div class="gf-form-group">
...
`,a=s,e="public/app/plugins/panel/graph/time_regions_form.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},87724:t=>{var s=`<div class="editor-row">
  <div class="section gf-form-group">
...
`,a=s,e="public/app/plugins/panel/heatmap/partials/axes_editor.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},25557:t=>{var s=`<div class="editor-row">
  <div class="section gf-form-group">
...
`,a=s,e="public/app/plugins/panel/heatmap/partials/display_editor.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},47833:t=>{var s=`<div class="edit-tab-content" ng-repeat="style in editor.panel.styles">
  <div class="gf-form-group">
    <h5 class="section-heading">Options</h5>
    <div class="gf-form-inline">
      <div class="gf-form gf-form--grow">
...
`,a=s,e="public/app/plugins/panel/table-old/column_options.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},22559:t=>{var s=`<div class="gf-form-group">
  <div class="grafana-info-box">
...
`,a=s,e="public/app/plugins/panel/table-old/editor.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},32178:t=>{var s=`<div class="table-panel-container">
