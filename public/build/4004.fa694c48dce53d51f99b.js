"use strict";(self.webpackChunkgrafana=self.webpackChunkgrafana||[]).push([[4004],{14004:(xe,de,B)=>{B.d(de,{J:()=>fe});var v=B(67163),ge=B.n(v),O=B(76687),A=B(14779),U=B(78426),R=B(82102);const se="ctrl+1",ye=new(ge())(document.body),fe=({children:te,pageId:ae,pageNav:W,isLoading:Y})=>{const[Q,ue]=(0,O.useState)(!1);return(0,O.useEffect)(()=>(ye.bind(se,()=>{ue(Z=>!Z)}),()=>{ye.unbind(se)}),[]),O.createElement(A.AN,{features:R.Z},O.createElement(U.T,{pageNav:W,navId:ae},O.createElement(U.T.Contents,{isLoading:Y},te)),Q?O.createElement(A.zJ,{defaultOpen:!0}):null)}},82102:(xe,de,B)=>{B.d(de,{Z:()=>O,v:()=>v});var v=(A=>(A.NotificationPoliciesV2MatchingInstances="notification-policies.v2.matching-instances",A))(v||{});const O=[{name:"notification-policies.v2.matching-instances",defaultValue:!1}]},14779:(xe,de,B)=>{B.d(de,{AN:()=>Ki,zJ:()=>ta,Qb:()=>Kr});/*! *****************************************************************************
 ...
 */var v=B(76687);function ge(W,Y){return W===Y&&(W!==0||1/W===1/Y)||W!==W&&Y!==Y}var O=typeof Object.is=="function"?Object.is:ge,A=v.useState,U=v.useEffect,R=v.useLayoutEffect,se=v.useDebugValue;function ye(W,Y){var Q=Y(),ue=A({inst:{value:Q,getSnapshot:Y}}),Z=ue[0].inst,he=ue[1];return R(function(){Z.value=Q,Z.getSnapshot=Y,fe(Z)&&he({inst:Z})},[W,Q,Y]),U(function(){return fe(Z)&&he({inst:Z}),W(function(){fe(Z)&&he({inst:Z})})},[W]),se(Q),Q}function fe(W){var Y=W.getSnapshot;W=W.value;try{var Q=Y();return!O(W,Q)}catch{return!0}}function te(W,Y){return Y()}var ae=typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"?te:ye;de.useSyncExternalStore=v.useSyncExternalStore!==void 0?v.useSyncExternalStore:ae},34293:(xe,de,B)=>{/**
 * @license React
